...
const t = {
  es: {
    ...
    "about.eyebrow": "Clínica familiar", "about.title": "24 años de experiencia con trato familiar.", "about.copy": "ARSDENT ofrece atención dental de alta calidad con tecnología avanzada y un equipo comprometido con sonrisas sanas y bonitas.",
  ...
  en: {
    ...
    "about.eyebrow": "Family clinic", "about.title": "24 years of experience, warm family care.", "about.copy": "ARSDENT offers high-quality dental care with advanced technology and a professional team committed to healthy, beautiful smiles.", "stats.exp": "years experience", "stats.lang": "languages", "stats.exam": "first check-up",
  ...
  ru: {
    ...
    "about.eyebrow": "Семейная клиника", "about.title": "24 года опыта и теплый семейный подход.", "about.copy": "ARSDENT предлагает качественную стоматологическую помощь с современными технологиями и командой, которая заботится о здоровых и красивых улыбках.", "stats.exp": "года опыта", "stats.lang": "языков", "stats.exam": "первый осмотр",
...
t.uk = {
  ...
  "about.eyebrow": "Сімейна клініка", "about.title": "24 роки досвіду і теплий сімейний підхід.", "about.copy": "ARSDENT пропонує якісну стоматологічну допомогу з сучасними технологіями та командою, яка дбає про здорові й красиві усмішки.", "stats.exp": "роки досвіду", "stats.lang": "мов", "stats.exam": "перший огляд",
...
t.ar = {
  ...
  "about.eyebrow": "عيادة عائلية", "about.title": "24 سنة خبرة مع رعاية عائلية دافئة.", "about.copy": "تقدم ARSDENT رعاية أسنان عالية الجودة بتقنيات متقدمة وفريق يهتم بابتسامات صحية وجميلة.", "stats.exp": "سنة خبرة", "stats.lang": "لغات", "stats.exam": "الفحص الأول",
...
t.de = {
  ...
  "about.eyebrow": "Familienpraxis", "about.title": "24 Jahre Erfahrung mit herzlicher Familienbetreuung.", "about.copy": "ARSDENT bietet hochwertige Zahnmedizin mit moderner Technologie und einem Team, das sich für gesunde, schöne Lächeln einsetzt.", "stats.exp": "Jahre Erfahrung", "stats.lang": "Sprachen", "stats.exam": "erster Check-up",
